...
class CustomChatCompletionMessageParam(TypedDict, total=False):
    ...
    tts_content: dict[str, str]
    """The tts content for step tts audio model"""
...
def _parse_chat_message_content(
    ...
    for result_msg in result:
        ...
        if "tts_content" in message and isinstance(message['tts_content'], dict): # noqa: E501
            result_msg['tts_content'] = message['tts_content']
